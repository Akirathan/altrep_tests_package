...
static void _test_altrep_inheritance()
{
    SEXP instance = wrapper_new_altrep(_class_descriptor, R_NilValue, R_NilValue);
...
static void _test_instance_data()
{
	...
	*data_ptr = 42;
    ...
    SEXP instance = wrapper_new_altrep(_class_descriptor, expected_instance_data1, expected_instance_data2);
...
static void _test_modify_instance_data()
{
    ...
    SEXP instance = PROTECT(wrapper_new_altrep(_class_descriptor, int_vec, R_NilValue));

    SET_INTEGER_ELT(wrapper_altrep_data1(instance), 0, 42);

    SEXP actual_data1 = wrapper_altrep_data1(instance);
...
static void _test_set_instance_data()
{
    SEXP instance = PROTECT(wrapper_new_altrep(_class_descriptor, R_NilValue, R_NilValue));
    ...
    int default_flags = 16;
    CHECK( R_compute_identical(wrapper_altrep_data1(instance), int_vec, default_flags));
    CHECK( R_compute_identical(wrapper_altrep_data2(instance), lgl_vec, default_flags));
